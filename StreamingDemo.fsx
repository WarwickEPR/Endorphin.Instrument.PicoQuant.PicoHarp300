...
let experiment = asyncChoice {
    ...
    PicoHarp.Initialise.initialiseMode picoHarp T2 |> ignore

    try
        let acquisition = Streaming.Acquisition.create picoHarp (Streaming.Parameters.create (Duration_ns 10.0<ns>) (Duration_ns 1000.0<ns>))
